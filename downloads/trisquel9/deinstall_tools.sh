...
# 	 deinstall_tools.sh
#	 Deletes tools installed by VSTENO install script (install_vsteno.sh) 	 
#    giving the user the possibility to decide if it should be removed
#    or kept (e.g. if it is still used by other programs, like for example
#    apache web server or hunspell program and dictionary).
#
#    Copyright (c) 2020-2021  Norwid Behrnd
#
