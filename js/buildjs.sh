...
cat license.txt global_functions_code.js static_graphical_elements_code.js freehand_code.js rotating_axis_code.js connection_points_code.js drawing_area_code.js vsteno_editor_main_code.js > vsteno_editor.js
