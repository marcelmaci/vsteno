...
// version
const version_commit_id = "748ab7a19981738fdd09a71d59faf1cd32510d5b";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "9. Oktober 2018";                                  // idem
