...
// version
const version_commit_id = "f10f6ed768505d6a677171399973ce4981e0d074";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "31. Juli 2018";                                   // idem
