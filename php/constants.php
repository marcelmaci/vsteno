...
// version
const version_commit_id = "37f9d86132d49545e968e509036f932aae58ee3a";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "2. Juli 2019";                                  // idem
