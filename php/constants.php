...
// version
const version_commit_id = "a63ff30bf6291ae0797902a368cbc6970995c0f5";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "28. März 2019";                                  // idem
