...
// version
const version_name = "Hyperion (latest) - 30/10/2020"; // official release name
const version_number = "0.3"; // two digit version number (can be used to test compatibility with models)
const version_commit_id = "07ed22142e223ce5e6b2c5a40b4e9c2ed0a171e9";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "30/10/2020";  // idem
