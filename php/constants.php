...
// version
const version_name = "Hyperion (latest) - 12/07/2020"; // official release name
const version_number = "0.3"; // two digit version number (can be used to test compatibility with models)
const version_commit_id = "2a3ba9da2f30c96f906b9e5b440a1789c13aff86";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "12/07/2020";  // idem
