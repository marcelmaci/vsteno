...
// version
const version_commit_id = "8a1e16d5db840e003fa39df3896b833d225423d1";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "9. Juni 2019";                                  // idem
