...
// version
const version_commit_id = "876c57743476bc772c069c58d0f5999f4b9e1ebc";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "10. April 2019";                                  // idem
