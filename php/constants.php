...
// version
const version_commit_id = "b7d1d4b72eda570002392d6f8e514060c36f3a78";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "3. Mai 2019";                                  // idem
