...
// version
const version_commit_id = "301df778aaef397855c4937456c50064b36fe788";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "27. Februar 2019";                                  // idem
