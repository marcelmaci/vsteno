...
// version
const version_commit_id = "14c92354f95e9891a35367803fc7a15ab572a6e3";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "9. August 2018";                                  // idem
