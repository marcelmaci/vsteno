...
// version
const version_commit_id = "e303bd6dc5272cfc9c80dee10169504805d8438a";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "5. März 2019";                                  // idem
