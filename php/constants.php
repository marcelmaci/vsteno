...
// version
const version_commit_id = "92658f24760dceacbe05d7bbf5a908bcd13307a2";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "7. März 2019";                                  // idem
