...
// version
const version_name = "Ariadne+ (6. Dezember 2019)"; // official release name
const version_number = 0.3; // two digit version number (can be used to test compatibility with models)
const version_commit_id = "1e11a8925132048915bba980fafc2fd88c4e4073";   // must be inserted manually after commit => could be from last commit if forgotten
const version_date = "6. Dezember 2019";  // idem
