...
$cookie_table = array(
    ...
    /*3*/ array( 400, 120, "align_left", 5, 0, 2, 0, 2.7, 2.6, 1.05, 14, "Wenn man zwei Stunden lang mit einem Mädchen zusammensitzt, meint man, es wäre eine Minute. Sitzt man jedoch eine Minute auf einem heißen Ofen, meint man, es wären zwei Stunden. Das ist Relativität.<@token_type=svgtext>Albert Einstein<@token_type=shorthand>" ),
    ...
    /*6*/ array( 360, 120, "align_left", 5, 0, 6, 0, 3.15, 2.6, 1.1, 14, "Um eine Ein|kommens steuer erklärung abgeben zu können, muss man Philosoph sein. Für einen Mathematiker ist es zu schwierig.<@token_type=svgtext>Albert Einstein<@token_type=shorthand>" ),
    ...
    /*8*/ array( 360, 120, "align_left", 5, 0, 15, 0, 2.7, 2.6, 1.05, 14, "Es gibt Schlimmeres als den Tod. Wer schon einmal einen Abend mit einem Versicherungs|ver|treter zugebracht hat, wird wissen, was ich meine.<@token_type=svgtext>Woody Allen<@token_type=shorthand>" ),
   ...
   /*11*/ array( 370, 120, "align_left", 5, 0, 8, 0, 3.4, 2.6, 1.05, 14, "Getöse beweist gar nichts. Eine Henne, die gerade ein Ei gelegt hat, gackert häufig so, als hätte sie einen Asteroiden gelegt. <@token_type=svgtext>Mark Twain<@token_type=shorthand>" ),
   ...
   /*13*/ array( 355, 120, "align_left", 5, 0, 8, 0, 2.7, 2.6, 1.25, 14, "Was auch immer geschieht: Nie dürft ihr so tief sinken, von dem Kakao, durch den man euch zieht, auch noch zu trinken.<@token_type=svgtext>Erich Kästner<@token_type=shorthand>" ),
   ...
   /*16*/ array( 300, 120, "align_left", 5, 0, -5, 0, 3.1, 3.5, 1.2, 14, "Seit jenem Tag, an dem der erste Schuft seinen ersten Dummkopf fand, gibt es Quacksalber.<@token_type=svgtext>Voltaire<@token_type=shorthand>" ),
   /*17*/ array( 300, 120, "align_left", 5, 0, -5, 0, 3.1, 3.5, 1.2, 14, "Je planmässiger die Menschen vorgehen, desto wirksamer vermag sie der Zufall zu treffen.<@token_type=svgtext>Friedrich Dürrenmatt<@token_type=shorthand>" ),
   /*18*/ array( 300, 120, "align_left", 5, 0, -5, 0, 3.1, 3.5, 1.2, 14, "Man muss noch Chaos in sich haben, um einen tanzenden Stern gebären zu können.<@token_type=svgtext>Friedrich Nietzsche<@token_type=shorthand>" ),
   /*19*/ array( 380, 120, "align_left", 5, 0, -5, 0, 3.1, 3.5, 1.2, 14, "Unter Intuition versteht man die Fähigkeit gewisser Leute, eine Lage in Sekundenschnelle falsch zu beurteilen.<@token_type=svgtext>Friedrich Dürrenmatt<@token_type=shorthand>" ),
   /*20*/ array( 300, 120, "align_left", 5, 0, 20, 0, 3.1, 3.5, 1.2, 14, "Es gibt zu viele Wichtigtuer, die nichts Wichtiges tun.<@token_type=svgtext>Friedrich Dürrenmatt<@token_type=shorthand>" ),
   /*21*/ array( 420, 120, "align_left", 5, 0, -5, 0, 3.1, 3.5, 1.05, 14, "Das menschliche Wissen ist dem menschlichen Tun davongelaufen, das ist unsere Tragik. Trotz aller unserer Kenntnisse verhalten wir uns immer noch wie die Höhlenmenschen von einst.<@token_type=svgtext>Friedrich Dürrenmatt<@token_type=shorthand>" ),
   /*22*/ array( 300, 120, "align_left", 5, 0, -5, 0, 3.1, 3.5, 1.2, 14, "Die beste und sicherste Tarnung ist immer noch die blanke und nackte Wahrheit. Die glaubt niemand!<@token_type=svgtext>Max Frisch<@token_type=shorthand>" ),
   /*23*/ array( 300, 120, "align_left", 5, 0, 20, 0, 3.1, 3.5, 1.2, 14, "Die meisten verwechseln Da|bei\sein mit Erleben.<@token_type=svgtext>Max Frisch<@token_type=shorthand>" ),
   /*24*/ array( 300, 120, "align_left", 5, 0, 20, 0, 3.1, 3.5, 1.2, 14, "Die Zeit verwandelt uns nicht, sie entfaltet uns nur.<@token_type=svgtext>Max Frisch<@token_type=shorthand>" ),
   /*25*/ array( 300, 120, "align_left", 5, 0, -5, 0, 3.1, 3.5, 1.2, 14, "Wenn ich übers Wasser laufe, dann sagen meine Kritiker, nicht mal schwimmen kann er.<@token_type=svgtext>Berti Vogt<@token_type=shorthand>" ),
   /*26*/ array( 300, 120, "align_left", 5, 0, 20, 0, 3.1, 3.5, 1.2, 14, "Humor ist der Knopf, der verhindert, dass uns der Kragen platzt.<@token_type=svgtext>Joachim Ringelnatz<@token_type=shorthand>" ),
