...
if (($_SESSION['user_logged_in']) && ($_SESSION['user_privilege'])) {
    if (($_SESSION['user_privilege'] > 1) || (($_SESSION['user_privilege'] == 1) && ($_SESSION['model_standard_or_custom'] === "custom"))) {
        ...
        echo "<h1>Olympus</h1><p>Hier können Sie den folgenden Eintrag aus Olympus ($olympus) bearbeiten.</p>";
      ...
      // Create connection
        ...
        $sql = "SELECT * FROM $olympus WHERE word_id='$safe_word_id'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<form action='olympus2.php' method='post'>";
